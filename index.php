                ...
                if ($row > 0) {
                    while ($row = mysqli_fetch_array($ret)) {
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="read.php?viewid=<?php echo htmlentities($row['code']); ?>" class="view"
                                   title="View" data-toggle="tooltip"><i class="material-icons">&#xE417;</i></a>
                                <a href="edit.php?editid=<?php echo htmlentities($row['code']); ?>" class="edit"
                                   title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                                <a href="index.php?delid=<?php echo($row['code']); ?>" class="delete" title="Delete"
